...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 17, 2025 at 03:09 PM
...
(105, '2025-10-01', '2025-10-31', 15, 191881.00, 19),
...
(139, '2025-10-01', '2025-10-31', 20, 10000.00, 5);
...
(6, '2025-10-01', '2025-10-31', 2285941.00, 441);
...
(105, '2025-10-13', '2025-10-19', 15, 191881.00, 19),
...
(139, '2025-10-13', '2025-10-19', 20, 10000.00, 5);
...
(43, '2025-10-13', '2025-10-19', 1428441.00, 153);
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_store_sales_forecast_daily`  AS SELECT cast(`sales`.`SalesDate` as date) AS `Period`, sum(`sales`.`Quantity`) AS `TotalQuantity`, round(avg(sum(`sales`.`Quantity`)) OVER (ORDER BY cast(`sales`.`SalesDate` as date) ROWS BETWEEN 2 PRECEDING AND CURRENT ROW) ,2) AS `MovingAverage3` FROM `sales` GROUP BY cast(`sales`.`SalesDate` as date) ORDER BY cast(`sales`.`SalesDate` as date) ASC ;
...
--
ALTER TABLE `daily_sales`
  MODIFY `DailySales_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=140;

--
-- AUTO_INCREMENT for table `daily_total_sales`
--
ALTER TABLE `daily_total_sales`
  MODIFY `EntireDailySales_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;

--
-- AUTO_INCREMENT for table `expiration`
--
ALTER TABLE `expiration`
  MODIFY `Expiration_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `monthly_sales`
  MODIFY `MonthlySales_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=140;

--
-- AUTO_INCREMENT for table `monthly_total_sales`
--
ALTER TABLE `monthly_total_sales`
  MODIFY `EntireMonthlySales_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;
...
--
ALTER TABLE `restock`
  MODIFY `Orestock_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;

--
-- AUTO_INCREMENT for table `sales`
--
ALTER TABLE `sales`
  MODIFY `Order_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=167;
...
--
ALTER TABLE `weekly_sales`
  MODIFY `WeeklySales_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=140;

--
-- AUTO_INCREMENT for table `weekly_total_sales`
--
ALTER TABLE `weekly_total_sales`
  MODIFY `EntireWeeklySales_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;
